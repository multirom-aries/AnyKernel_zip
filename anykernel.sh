...
chmod -R 777 $ramdisk/res/crontab
chmod -R 777 $ramdisk/res/crontab_service
...
if [ -f /sbin/777-post_boot.sh ]; then
remove_file /sbin/777-post_boot.sh;
remove_section init.g3.rc "service 777-post-boot" "start 777-post-boot"
fi
